...
export const WINDOWS_INFO: WindowInfo[] = [
  ...
  {
    id: 4,
    name: 'Voice Interaction & Prompts',
    arabicName: 'بوابة التفاعل الصوتي وتوليد الصور بالصوت',
    shortDesc: 'توليد الصور والأوامر الاحترافية عبر التسجيل الصوتي المباشر والإملاء الذكي.',
    fullDesc: 'تحدث بصوتك الطبيعي أو اكتب فكرتك، ليقوم الذكاء الاصطناعي بمراجعة طلبك وصياغة برومبت دقيق وتوليد الصورة فوراً مع إمكانية الاستماع والتحميل والمشاركة.',
    type: 'image',
    aspectRatioLabel: '1:1 مربع / 16:9 شاشة عريضة',
...
export const INITIAL_ADS: AdBanner[] = [
  ...
  {
    id: 'ad-5',
    title: 'منصة توليد الفيديوهات السينمائية Runway Gen-3 و Luma Dream',
    sponsorName: 'Cinematic AI Studio',
    badgeText: 'بانر عريض',
    description: 'حول النصوص والصور الثابتة إلى مقاطع سينمائية 4K مع تحكم كامل بزوايا الكاميرا والمؤثرات البصرية.',
  ...
  {
    id: 'ad-6',
    title: 'محرك تصميم الشعارات والهويات البصرية بالفيكتور الذكي',
    sponsorName: 'VectorBrand AI',
    badgeText: 'إعلان 350x350',
    description: 'صمم شعارات علامات تجارية احترافية مفرغة الخلفية وقابلة للتكبير اللانهائي بصيغ SVG و PNG فائقة الدقة.',
    imageUrl: 'https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?auto=format&fit=crop&w=600&q=80',
    targetUrl: 'https://brandmark.io',
    ctaText: 'ابتكر شعارك الآن',
    category: 'branding',
    impressions: 3750,
    clicks: 310
  },
  {
    id: 'ad-7',
    title: 'أقوى شبكة تخزين سحابي وسيرفرات Cloudflare Edge فائق السرعة',
    sponsorName: 'Cloudflare Workers & R2',
    badgeText: 'بانر عريض',
    description: 'استضف ملايين الصور والملفات بدون رسوم خروج للبيانات مع استجابة فائقة في أقل من 20 مللي ثانية حول العالم.',
    imageUrl: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=600&q=80',
  ...
  {
    id: 'ad-8',
    title: 'استوديو الهندسة الصوتية والموسيقى التوليدية بالذكاء الاصطناعي',
    sponsorName: 'Suno & Udio Audio AI',
    badgeText: 'إعلان تفاعلي',
    description: 'أنشئ مقاطع صوتية وموسيقى ومؤثرات سينمائية كاملة بأصوات احترافية لمقاطع اليوتيوب والشورتس.',
    imageUrl: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=600&q=80',
    targetUrl: 'https://suno.com',
    ctaText: 'استمع ونفّذ مجاناً',
    category: 'audio',
    impressions: 3200,
    clicks: 275
  },
  {
    id: 'ad-9',
    title: 'حلول تحسين محركات البحث SEO والأرشفة الفورية للروابط الذكية',
    sponsorName: 'RankBoost SEO',
    badgeText: 'إعلان مميز',
    description: 'تصدر نتائج البحث في جوجل مع أدوات فحص الكلمات المفتاحية وتحليل الروابط التلقائي.',
    imageUrl: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=600&q=80',
    targetUrl: 'https://google.com/search-console',
    ctaText: 'فحص موقعك مجاناً',
    category: 'seo',
    impressions: 2900,
    clicks: 230
  },
  {
    id: 'ad-10',
    title: 'منصة الذكاء الاصطناعي لتحليل الرؤية الحاسوبية وقراءة الصور',
    sponsorName: 'VisionAI Extractor',
    badgeText: 'بانر عريض 728x90',
    description: 'استخرج النصوص والبرومبتات الدقيقة من أي صورة بنقرة واحدة بدقة 99.8% مع كشف الألوان والزوايا.',
    imageUrl: 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&w=600&q=80',
    targetUrl: 'https://cloud.google.com/vision',
    ctaText: 'تجربة محرك الرؤية',
    category: 'vision',
    impressions: 4680,
    clicks: 390
  }
...
export const INITIAL_DEV_SETTINGS: DevSettings = {
  ...
  cloudflare: {
    ...
    apiToken: '',
    zoneId: '',
    workerUrl: 'https://roohpro.com/ai',
    isConnected: false,
